    ...
    <div class="col-lg-12">
        <section class="panel">
            ...
            <div class="drawchintantable">
                <?php $this->chintantable->createsearch("Registered Users");?>
