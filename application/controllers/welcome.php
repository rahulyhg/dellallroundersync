...
$userid2 = $user["id"];
  ...
  //echo "INSERT INTO USERS (name, email, phone,message, dots, jerseyscore, testtime, certificate) VALUES ('$username','$useremail','$userphone','$usermessage','$userdots','$userjerseyscore','$usertesttime', '$usercertificate')";
        $query=$this->db->query("INSERT INTO `users` (name, email, phone,message, dots, jerseyscore, testtime, certificate) VALUES ('$username','$useremail','$userphone','$usermessage','$userdots','$userjerseyscore','$usertesttime', '$usercertificate')");
